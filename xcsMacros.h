...
const double pX = 0.8; // 0.04; //0.04; //The probability of applying crossover in an offspring classifier.
const int crossoverType = 2; // 0 uniform, 1 onePoint, and 2 twoPoint crossover.
const double pM = 0.04; //0.8; //The probability of mutating one allele and the action in an offspring classifier.
...
const int theta_filter = 10; // A classifier is "promising" if its experience > theta_filter and error < epsilon_0
